    ...
    <MainLayout>
        <div id="ShoppingCartPage" class="mt-4 max-w-[1200px] mx-auto px-2">
            <div v-if="false" class="h-[500px] flex items-center justify-center">
                <div class="pt-20">
                    <img class="mx-auto" width="200" src="/cart-empty.png" alt="Imagem de um carrinho vazio">
                    <div class="text-xl text-center mt-4">No items yet?</div>
                    <div v-if="true" class="flex text-center">
                        <NuxtLink to="/auth"
                            class="bg-[#FD3747] w-full text-white text-[21px] font-semibold p-1.5 rounded-full mt-4">
                            Sign in
                        </NuxtLink>
                    </div>
                </div>
                    ...
                    <div id="PaymentProtection" class="bg-white rounded-lg p-4 mt-4">
                        ...
                        <div class="flex items-center justify-start gap-8 my-4">
                            <div v-for="card in cards">
                                <img class="h-6" :src="card.flag" :alt="card.alt">
                            </div>
                        </div>
                    </div>
                </div>
...
onMounted(() => {
    setTimeout(() => userStore.Store.isLoading = false, 200)
})

const cards = [
    {flag: 'visa.png', alt: "Visa description"},
    {flag: 'mastercard.png', alt: "Mastercard description"},
    {flag: 'paypal.png', alt: "Paypal description"},
    {flag: 'applepay.png', alt: "Applepay description"}
]
