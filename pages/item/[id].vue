            ...
            <div class="md:flex gap-4 justify-between mx-auto w-full">
                    ...
                    <div v-if="images[0] !== ''" class="flex items-center justify-center mt-2">
                        <div v-for="image in images">
                            <img @mouseover="currentImage = image" @click="currentImage = image" width="70"
                                ...
                                :style="{ border: currentImage === image ? '2px solid #ff5353' : 'none' }" :src="image"
                                alt="This is an inclusive description of the image">
                        </div>
                    </div>
                </div>
                <div class="md:w-[50%] bg-white p-3 rounded-lg">
                    ...
                    <div class="flex items-center justify-start my-2">
                        ...
                        <Icon name="material-symbols:star-rounded" color="#FF5353" />
                        <Icon name="material-symbols:star-rounded" color="#FF5353" />
                        <span class="text-[13px] font=light ml-2">5 213 Reviews 1000+ orders</span>
                    </div>
                    ...
                    <p class="text-[#009a66] text-xs font-semibold pt-1">Free 11-day delivery over $20.00</p>
