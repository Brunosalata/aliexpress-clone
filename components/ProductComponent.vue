<template>
    <div :id="`ProductComponent${product.id}`"
        class="bg-white inline-blaco rounded hover:shadow-[0_0_10px_3px_rgba(0,0,0,0.15)] cursor-pointer">
        <NuxtLink :to="`/item/${product.id}`">
            ...
            <div id="ProductDetails">
                ...
                <span class="px-1 realtive -top-1.5 text-[#ff4646] text-xs font-semibold">Extra 5% off</span>
                <div class="flex items-center gap-1 px-1 relative -top-1">
                    ...
                    <span class="bg-[#f5f5f5] border text-[#c08562] text-[9px] fonte-semibold px-1.5 rounded-sm">Top
                        Selling</span>
                </div>
                <p class="flex items-center px-1 pt-0.5 text-xs text-[#252525]">
                    5000+ sold
                    <Icon name="material-symbols:star-rate" style="color:#757575" class="ml-1.5" />4.7
                </p>
